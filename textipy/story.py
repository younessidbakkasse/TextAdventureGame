from scene import StoryScene

scenario_en = {
    # Creating main game scenes ########################################
    'Pregame' : StoryScene('Pregame', [['Start playing', 'Beach', 'loot-water']], "Hi there and welcome. Dead Island is story game, your actions impact the story flow. Decide carefully, check your inventory from time to time, equip best weapons because it's scary what's waiting you out there."),
    ...
    # won the fight 
    'Shallows' : StoryScene('Shallows', [['Study the footprints', 'Match', 'loot-skull'], ['Approach the shack', 'Shack', 'normal']], "Tucked away in lush vegetation, a small shack lies on the outskirts of a deep forest.  You discover a fresh set of footprints on a dirt path nearby, leading into the northern forest."),
    ...
    'Forest' : StoryScene('Forest', [['Approach the camp', 'Camp', 'loot-map']], "Seemingly without end, the winding path takes you deep into the forest. The pines are now enveloped by the shimmering light of the golden dusk. Smoke is rising from a campfire in the distance."),
    ...
    'Blood' : StoryScene('Blood', [['Keep moving', 'Owl', 'loot-pearl']], "The bloodstained footprints lead to another path throught the forest. Forging ahead, you are faced with increasingly rugged terrain. Forced to constantly walk uphill, you lose yourself on the northern highlands."),
