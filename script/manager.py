...
class Game:
    def __init__(self):
        ...
        self.scenes = {
            ...
            'Something' : StoryScene('Something', [['Fight him', 'Lagoon', 'fight-dog'], ['Take the knife', 'Lagoon', 'loot-knife']], "Something near the water has caught your attention, prompting you to take a quick look. Closer scrutiny reveals a rusty knife. While hardly ideal, it's better than nothing."),
            # Lagoon
