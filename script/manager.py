...
class Game:
    def __init__(self):
        ...
        self.scenes = {
            ...
            # Fight scene
            'First enemy' : StoryScene('First enemy', [['Fight', 'Second loot', 'fight-death claw']], "Something is moving through the reeds on the other side. A wild dog emerges. Growling, it runs towards you across the shallows."),
