...
class Game:
    def __init__(self):
        ...
        self.scenes = {
            ...
            # one step scene
            'Study the footprints' : StoryScene('Study the footprints', ['Follow the footprints'], 'They are somewhat small and delicate. You arrive at the concusion that they were made by a person below average height, walking barefoot.'),
            'Follow the footprints' : StoryScene('Follow the footprints', ['Leave it', 'Take the knife'], "Something near the water has caught your attention, prompting you to take a quick look. Closer scrutiny reveals a rusty knife. While hardly ideal, it's better than nothing."),
        }
