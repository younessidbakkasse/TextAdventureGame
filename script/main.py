...
from template import (home_template, menu_template, before_game_template, 
inventory_template, credit_template, howtoplay_template,stats_template, 
store_template, quests_template)
