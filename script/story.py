...
You * * * * * * * * * * * 
    ...
    * * * * * * * * * * * Boss
    ...
    boss. each scene will have minimum one choice and maximum 3 direction choices but there will 
    be other choices depending on the map if it contains monsters or objects. Once you passed a scene
